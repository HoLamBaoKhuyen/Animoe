...
const AnimeSearchPage = () => {
  ...
  return (
    <SearchPageUnit
      searchParams={{ params: searchParams, setParams: setSearchParams }}
      searchType="/anime-search"
      searchData={useGetAnimeSearchQuery}
    />
  );
};
const MangaSearchPage = () => {
  ...
  return (
    <SearchPageUnit
      searchParams={{ params: searchParams, setParams: setSearchParams }}
      searchType="/manga-search"
      searchData={useGetMangaSearchQuery}
    />
  );
};
