...
const RecommendationsPageHeader = () => {
  ...
  return (
    <Box>
        ...
        <Grid item xs={12} container>
            <Grid item xs={12} md={4} sx={{ display: "flex", justifyContent: "right", alignItems:"center"}}>
                <Box >
            ...
            <Grid item xs={12} md={4} sx={{ display: "flex", justifyContent: "left", alignItems:"center"}}>
                <Box>
