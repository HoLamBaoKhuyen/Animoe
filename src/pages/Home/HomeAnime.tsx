...
import {Box, Button, Card, CardActions, CardContent, Chip, Grid, Link, Popover, Typography} from "@mui/material";
            ...
            >
                <Card>
                    <CardContent sx={{ minWidth: {md: 320, sm: 120}}}>
                        ...
                        >
                            {anime.type} {data ? format_episode(anime.episodes, data.length, anime.status) : null}
                        </Typography>
                        <Typography mt={0.25}
                            sx={{
                                fontSize: { md: 16, sm: 12 },
